...
const List = [
  ...
  },
  {
    ...
    children: [
        ...
        children: [
          {
            path: 'remixIcon',
            name: 'RemixIcon',
            component: '@/views/mc/icon/remixIcon',
            meta: {
              title: '小清新图标',
            },
          },
          {
            path: 'iconSelector',
            name: 'IconSelector',
            component: '@/views/mc/icon/iconSelector',
            meta: {
              title: '图标选择器',
            },
          },
      ...
      },
      {
        path: 'permission',
        name: 'Permission',
        component: '@/views/mc/permission/index',
        meta: {
          title: '角色权限',
          icon: 'user-3-line',
          badge: 'Pro',
        ...
        children: [
          {
            ...
            component: '@/views/mc/table/comprehensiveTable',
            meta: {
              title: '综合表格',
            },
          },
          {
            path: 'detail',
            name: 'Detail',
            component: '@/views/mc/table/detail',
            meta: {
              hidden: true,
              title: '详情页',
              activeMenu: '/mc/table/comprehensiveTable',
          ...
          },
          {
            ...
            component: '@/views/mc/table/inlineEditTable',
            meta: {
              title: '行内编辑表格',
              noKeepAlive: true,
            },
          },
          {
            path: 'customTable',
            name: 'CustomTable',
            component: '@/views/mc/table/customTable',
            meta: {
              title: '自定义表格',
            },
          },
          {
            path: 'dynamicTable',
            name: 'DynamicTable',
            component: '@/views/mc/table/dynamicTable',
            meta: {
              title: '动态表格',
              badge: 'New',
            },
      ...
      },
      {
        path: 'description',
        name: 'Description',
        component: '@/views/mc/description/index',
        meta: {
          title: '描述',
          guard: ['Admin'],
          icon: 'slideshow-line',
      ...
      },
      {
        path: 'calendar',
        name: 'Calendar',
        component: '@/views/mc/calendar/index',
        meta: {
          title: '日历',
          guard: ['Admin'],
        ...
        children: [
          {
            path: 'richTextEditor',
            name: 'RichTextEditor',
            component: '@/views/mc/editor/richTextEditor',
            meta: {
              title: '富文本编辑器',
              guard: ['Admin'],
            },
          },
          {
            path: 'wangEditor',
            name: 'WangEditor',
            component: '@/views/mc/editor/wangEditor',
            meta: {
              title: '腾讯文档',
              guard: ['Admin'],
              dot: true,
        ...
        children: [
          {
            ...
            component: '@/views/mc/form/comprehensiveForm',
            meta: {
              title: '综合表单',
            },
          },
          {
            path: 'stepForm',
            name: 'StepForm',
            component: '@/views/mc/form/stepForm',
            meta: {
              title: '分步表单',
            },
          },
          {
            path: 'button',
            name: 'Button',
            component: '@/views/mc/form/button',
            meta: {
              title: '按钮',
            },
          },
          ...
          },
          {
            path: 'checkbox',
            name: 'Checkbox',
            component: '@/views/mc/form/checkbox',
            meta: {
              title: '多选框',
            },
          },
          ...
          },
          {
            path: 'inputNumber',
            name: 'InputNumber',
            component: '@/views/mc/form/inputNumber',
            meta: {
              title: '计数器',
            },
          },
          {
            path: 'select',
            name: 'Select',
            component: '@/views/mc/form/select',
            meta: {
              title: '选择器',
              dot: true,
            },
          },
          {
            path: 'switch',
            name: 'Switch',
            component: '@/views/mc/form/switch',
            meta: {
              title: '开关',
            },
          },
          {
            path: 'slider',
            name: 'Slider',
            component: '@/views/mc/form/slider',
            meta: {
              title: '滑块',
            },
          },
          {
            path: 'timePicker',
            name: 'TimePicker',
            component: '@/views/mc/form/timePicker',
            meta: {
              title: '时间选择器',
            },
          },
          {
            path: 'datePicker',
            name: 'DatePicker',
            component: '@/views/mc/form/datePicker',
            meta: {
              title: '日期选择器',
            },
          },
          {
            path: 'dateTimePicker',
            name: 'DateTimePicker',
            component: '@/views/mc/form/dateTimePicker',
            meta: {
              title: '日期时间选择器',
            },
          },
  ...
  },
  {
    ...
    children: [
      ...
      //   path: 'mobilePreview',
      //   name: 'MobilePreview',
      //   component: '@/views/mc/mobilePreview',
      //   meta: {
      //     title: '手机预览',
      //     guard: ['Admin'],
      ...
      // },
      {
        path: '//github.com/minchao920917/vue-admin-plus?utm_source=gold_browser_extension',
        name: 'ExternalLink',
        meta: {
          title: '外链',
          target: '_blank',
