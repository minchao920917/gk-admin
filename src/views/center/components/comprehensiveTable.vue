...
<template>
  <div ref="containerRef" class="custom-table-container">
      ...
      <mc-query-form-left-panel>
        <el-form inline label-width="0" :model="queryForm" @submit.prevent>
          ...
          <el-form-item>
            ...
            <el-button :icon="Delete" type="danger" @click="handleDelete($event)"> 删除 </el-button>
            <el-button :icon="Folder" type="primary" @click="handleUpload"> 上传 </el-button>
          </el-form-item>
        </el-form>
      </mc-query-form-left-panel>
    ...
    <!-- 上传导入 -->
    <mc-upload
      :dialog-upload-visible="dialogImportVisible"
      :limit="1"
      :title="'物资导入'"
    ...
    >
      ...
      <template #downTemplate>
        <el-button link :size="'small'" type="primary" @click="downTemplate"> 下载模板 </el-button>
      </template>
    </mc-upload>
  </div>
</template>
