...
<template>
  <el-drawer v-model="state.drawerVisible" append-to-body class="mc-drawer" direction="rtl" size="400px"
    :title="translateTitle('系统主题配置')">
    <el-scrollbar height="88vh">
      <el-form ref="form" label-position="left" :model="theme">
        <el-tabs v-model="state.activeName">
            ...
            <el-form-item>
              <template #label>
                ...
                " effect="dark" placement="top">
                  <mc-icon icon="question-line" />
                </el-tooltip>
              </template>
              <el-select v-model="theme.layout" :disabled="device === 'mobile'" placeholder="请选择">
                <el-option key="column" :label="translateTitle('分栏')" value="column" />
                <el-option key="comprehensive" :label="translateTitle('综合')" value="comprehensive" />
                <el-option key="vertical" :label="translateTitle('纵向')" value="vertical" />
                <el-option key="horizontal" :label="translateTitle('横向')" value="horizontal" />
                <el-option key="common" :label="translateTitle('常规')" value="common" />
                <el-option key="float" :label="translateTitle('浮动')" value="float" />
              </el-select>
            </el-form-item>
            <el-form-item :label="translateTitle('主题色')">
              <el-select v-model="theme.themeName" @change="updateTheme">
                <el-option key="cyan-black" :label="translateTitle('青黑')" value="cyan-black" />
                <el-option key="cyan-white" :label="translateTitle('青白')" value="cyan-white" />
                <el-option key="blue-black" :label="translateTitle('蓝黑')" value="blue-black" />
                <el-option key="blue-white" :label="translateTitle('蓝白')" value="blue-white" />
                <el-option key="green-black" :label="translateTitle('绿黑')" value="green-black" />
                <el-option key="green-white" :label="translateTitle('绿白')" value="green-white" />
                <el-option key="purple-black" :label="translateTitle('紫黑')" value="purple-black" />
                <el-option key="purple-white" :label="translateTitle('紫白')" value="purple-white" />
                <!-- 红黑、红白主题完成群文档任务免费获取 -->
                <el-option key="red-black" :label="translateTitle('红黑')" value="red-black" />
                <el-option key="red-white" :label="translateTitle('红白')" value="red-white" />
                <!-- <el-option key="ocean" :label="translateTitle('渐变')" value="ocean" /> -->
              </el-select>
            </el-form-item>
            <el-form-item>
              <template #label>
                {{ translateTitle('分栏风格') }}
                <el-tooltip :content="translateTitle('分栏布局时生效')" effect="dark" placement="top">
                  <mc-icon icon="question-line" />
                </el-tooltip>
              </template>
              <el-select v-model="theme.columnStyle" :disabled="theme.layout !== 'column'">
                <el-option key="vertical" :label="translateTitle('纵向')" value="vertical" />
                <el-option key="horizontal" :label="translateTitle('横向')" value="horizontal" />
                <el-option key="card" :label="translateTitle('卡片')" value="card" />
                <el-option key="arrow" :label="translateTitle('箭头')" value="arrow" />
              </el-select>
            </el-form-item>
          </el-tab-pane>
          <el-tab-pane label="菜单设置" name="second">
            <el-form-item :label="translateTitle('菜单宽度')">
              <el-select v-model="theme.menuWidth" :disabled="
            ...
            <el-form-item class="mc-item-custom">
              <template #label>
                {{ translateTitle('菜单背景') }}
                <el-tooltip :content="
                  translateTitle(
              ...
              <el-radio-group v-model="theme.background" :disabled="
                theme.layout === 'float' || theme.layout === 'horizontal'
              " @change="updateTheme">
                <el-radio-button class="none" label="none" />
                <el-radio-button class="mc-background" label="mc-background" />
              </el-radio-group>
            </el-form-item>
          </el-tab-pane>
          <el-tab-pane label="顶部设置" name="three">
          ...
          <el-tab-pane label="标签设置" name="four">
            ...
            <el-form-item>
              <template #label>
                {{ translateTitle('标签图标') }}
                <el-tooltip :content="translateTitle('标签开启时生效')" effect="dark" placement="top">
                  <mc-icon icon="question-line" />
                </el-tooltip>
              </template>
            ...
            <el-form-item>
              ...
              <el-select v-model="theme.tabsBarStyle" :disabled="!theme.showTabs">
                <el-option key="card" :label="translateTitle('卡片')" value="card" />
                <el-option key="smart" :label="translateTitle('灵动')" value="smart" />
                <el-option key="smooth" :label="translateTitle('圆滑')" value="smooth" />
              </el-select>
            </el-form-item>
          </el-tab-pane>
        </el-tabs>
    ...
    .el-scrollbar__wrap {
      ...
      .el-form-item {
        ...
        .el-radio-button {
          ...
          &.mc-background {
            background: url(@/assets/theme_images/theme-bg.jpg);
            background-size: cover;
          }
        }
