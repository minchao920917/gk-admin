          ...
          <div class="right-panel">
            <el-menu :active-text-color="menuVariables['menu-color-active']"
              ...
              <!-- <template v-for="(item, index) in routes.flatMap((route) =>
                ...
                <mc-menu v-if="item['meta'] && !item['meta']['hidden']" :key="index + item['name']" :item="item"
                  :layout="layout" />
              </template> -->
              <el-menu-item index="/handle" @click="handleSelect('/handle')">审核中心</el-menu-item>
              <el-menu-item index="/center" @click="handleSelect('/center')">工作台</el-menu-item>
              <el-menu-item index="/messages" @click="handleSelect('/messages')">消息中心</el-menu-item>
            </el-menu>
            <mc-error-log />
            <mc-lock />
            <mc-search />
