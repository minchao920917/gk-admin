...
<template>
  <el-menu-item :index="itemOrMenu.path" @click="handleLink">
    <mc-icon v-if="itemOrMenu.meta.icon" :icon="itemOrMenu.meta.icon" :is-custom-svg="itemOrMenu.meta.isCustomSvg"
    ...
    <span v-if="itemOrMenu.meta.dot" class="mc-dot mc-dot-error">
      <span />
    </span>
  </el-menu-item>
</template>
